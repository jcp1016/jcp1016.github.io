...
Next I plotted poverty level by neighborhood from the ACS data, and made a heatmap of 311 calls by poverty level, based on the location of the caller.  Heating is the top complaint except in neighborhoods where fewer than 10% of the population had earnings below poverty level.<br />
...
Finally I built a large heatmap of the top complaints by community district, grouped by borough.<br />
