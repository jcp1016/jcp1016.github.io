...
1.  The graph is misleading, in part because of the title of the article.  It is based on thirty-two thousand calls placed during the first week of September 2010.  The number one complaint to 311 is for heating, which was missed because there are no heating complaints in late summer.  To quote Edward Tufte, "a puny dataset can't be rescued by a graphic".    
